...
A turn based console combat game. In this program the player and the enemy will take turns to attack each other. The last fighter standing will be the winner!
The following topics are covered: `User Input`, `Random Object`, `While loops` and `Conditional Statements`.
